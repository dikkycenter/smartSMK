          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php $i = 1;foreach ($data_presensi as $u): ?>
                <tr>  
                  <td><?php echo $i; ?></td>         
                  <td style="text-transform: uppercase;"><?php echo $u->nis; ?></td>
                  ...
                  <?php //foreach ($cek_presensi as $cek): ?>
                    <a class="btn" href="<?php echo site_url('presensi/updatePresensiDetail/'.$u->id); ?>">
